...
// This avoids running the model multiple times per request.
var (
...
func handleInference(w http.ResponseWriter, r *http.Request) {
	...
	// This mutex ensures that only one inference request (from tokenization to C++ call)
	// happens at a time, which is crucial for a stateless process model.
	inferenceMutex.Lock()
	...
	// --- 2. Inference via one-shot C++ process ---
